#!/bin/bash
# USAGE: ./RQ2_ExtremeScalability_L1.sh <CaseName> <ShortName> <RunID> [TotalShards] [StartShard] [EndShard]
...
echo "=== 🚀 EXTREME SCALABILITY (L1) STARTED: SHARDS $S_NODE to $E_NODE ==="
