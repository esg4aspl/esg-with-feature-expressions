...
comparativeEfficiencyTestPipeline/) and combines them into one Excel file per
SPL, with one sheet per approach x level combination.

No aggregation here — just collection of per-product rows.

Output per SPL:
    files/Cases/<SPL>/RQ1_<SPL>_perProduct.xlsx

Downstream scripts (rq1_03, rq1_04) read these Excel files.
