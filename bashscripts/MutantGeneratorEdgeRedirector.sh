...
# Example: ./MutantGeneratorEdgeRedirector.sh SVM SVM 30 0 3
...
# =======================================================
MAIN="tr.edu.iyte.esgfx.cases.${CASE_NAME}.MutationTesting_EdgeRedirector_${SHORT_NAME}"
# =======================================================
...
for i in $(seq $S_NODE $E_NODE); do
  # Define Log File
  # TODO: CHANGE LOG NAME PREFIX FOR EACH SCRIPT (e.g., run_mutantedgeredirector, run_testsequence...)
  LOG="${LOG_DIR}/run_mutantedgeredirector_s$(printf "%02d" $i).log"
