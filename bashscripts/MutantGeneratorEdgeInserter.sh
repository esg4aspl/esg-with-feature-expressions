...
MAIN="tr.edu.iyte.esgfx.cases.${CASE_NAME}.MutationTesting_EdgeInserter_${SHORT_NAME}"
JAVA_OPTS="-Xms$XMS -Xmx$XMX -XX:+UseG1GC"

echo "=== 🚀 STARTING: $N SHARDS ($CASE_NAME) ==="

# Clean old logs
rm -f "${LOG_DIR}/run_mutantedgeinserter_s*.log"
...
echo "To monitor logs: tail -f ${LOG_DIR}/run_mutantedgeinserter_s00.log"