...
# Example: ./TestSequenceRecorder.sh SVM SVM 30 0 3
...
# =======================================================
MAIN="tr.edu.iyte.esgfx.cases.${CASE_NAME}.TestSequenceRecorderApp_${SHORT_NAME}"
# =======================================================
...
for i in $(seq $S_NODE $E_NODE); do
  ...
  LOG="${LOG_DIR}/run_testsequencerecorder_s$(printf "%02d" $i).log"
