...
public class OLD_CaseStudyApp_FeatureInserterExperimental_BAv2 extends CaseStudyUtilities_BAv2 {
...
//			System.out.println("Euler Cycle: " + eulerCycle);
		...
		Set<ESG> featureESGSet = FeatureESGSetGenerator
				.createFeatureESGSet("files/Cases/BankAccountv3/featureESGModels");
