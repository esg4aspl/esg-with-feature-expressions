...
import tr.edu.iyte.esgfx.mutationtesting.mutationoperators.EventInserter;
...
public class MutantGeneratorEventInserter extends CaseStudyUtilities {

	public void generateMutants(String eventName, String featureName) throws Exception {
...
//			System.out.println("Euler Cycle: " + eulerCycle);
				...
				MutationOperator mutationOperator = new EventInserter(eventName,featureName);
				...
				for (Entry<String, ESG> entry : ((EventInserter) mutationOperator).getEdgeMutantMap().entrySet()) {
