...
public class CaseStudyApp_EdgeCoverage_BA extends CaseStudyUtilities_BA {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Product Configuration: " + ESGFxName);
...
//		System.out.println(ESGFx);
		...
		eulerCycleGeneratorForEdgeCoverage.generateEulerCycle(ESGFx);
