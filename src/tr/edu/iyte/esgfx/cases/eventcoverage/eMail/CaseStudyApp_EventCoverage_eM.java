...
public class CaseStudyApp_EventCoverage_eM extends CaseStudyUtilities_eM {
...
//		System.out.println(ESGFx);
		...
		TestSuiteFileWriter.writeEventSequenceSetAndEventCoverageAnalysisToFile(testsequencesFolderPath + ESGFxName + ".txt",
				CESsOfESG, coverage);
