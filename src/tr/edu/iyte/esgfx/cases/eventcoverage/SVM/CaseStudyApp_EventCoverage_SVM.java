...
public class CaseStudyApp_EventCoverage_SVM extends CaseStudyUtilities_SVM {
	...
	public static void main(String[] args) throws Exception {
		...
		// TestSuiteFileWriter.writeEventSequenceSetAndEventCoverageAnalysisToFile(testsequencesFolderPath
		// + ESGFxName + ".txt",CESsOfESG, coverage);

		// TestSequenceGenerationTimeMeasurementWriter.writeTimeMeasurement(timeElapsed1,
		// timemeasurementFolderPath,ESGFxName);
